...
<div class="page-container">
	<div class="text-c">
		<form class="Huiform" method="post" action="" target="_self">
			...
			</span><a href="chengshi-add"><button type="button" class="btn btn-success" id="" name="" onClick="picture_colume_add(this);"><i class="Hui-iconfont">&#xe600;</i> 添加</button></a>
		</form>
	</div>
...
<!--  digui  一种-->
					<td>
					<?php echo str_repeat("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;",($v['f']-1)*2) ?><?=$v['cname'] ?>
					</td>
				<td><?=$v['ctime'] ?></td>
