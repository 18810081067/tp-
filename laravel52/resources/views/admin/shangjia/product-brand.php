...
<div class="page-container">
	<div class="text-c">
		<form class="Huiform" method="post" action="" target="_self">
			...
			</span><a href="shangjiaadd"><button type="button" class="btn btn-success" id="" name="" onClick="picture_colume_add(this);"><i class="Hui-iconfont">&#xe600;</i> 添加</button></a>
			...
			<tbody>
				...
				<td>
					...
					$dsn = "mysql:host=localhost;dbname=dingcan";
   					...
   					//var_dump($db)
		 			$rs = $db->query("select cid,cname from ding_city where cid='$v[cid]'");
		   			$ar = $rs->fetch();
		   			echo $ar['cname'];
 		 			?>						 		
				</td>

					<td class="text-l"><?=$v['sphone'] ?></td>
					<td><?=$v['stime'] ?></td>
